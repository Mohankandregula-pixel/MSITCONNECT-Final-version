        ...
        if (state) {
            return (
                <>
                    ...
                    {/* <li className="nav-item">
                        <NavLink exact activeClassName="active-page" className="nav-link" to="/Resources">Resources</NavLink>
                    </li> */}
                    <li className="nav-item">
                        <NavLink exact activeClassName="active-page" className="nav-link" to="/contact">Contact</NavLink>
                    <li className="nav-item">
                        <NavLink exact activeClassName="active-page" className="nav-link" to="/Library">Library</NavLink>
                    </li>
                    </li>
                    <li className="nav-item">
